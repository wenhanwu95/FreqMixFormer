...
from .spa_freq_mixf import Spatial_Freq_MixFormer
...
class Ske_MixF(nn.Module):
    def __init__(self, in_channels, out_channels, A, Frames, stride=1, residual=True):
        ...
        self.spa_mixf = Spatial_Freq_MixFormer(in_channels, out_channels, A)
...
class Model(nn.Module):
    def __init__(self, num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3):
        ...
        # self.l3 = Ske_MixF(80, 80, A, 52)
        # self.l4 = Ske_MixF(80, 80, A, 52)
        # self.l5 = Ske_MixF(80, 160, A, 26, stride=2)
        # self.l6 = Ske_MixF(160, 160, A, 26)
        # self.l7 = Ske_MixF(160, 160, A, 26)
        # self.l8 = Ske_MixF(160, 320, A, 13, stride=2)
        # self.l9 = Ske_MixF(320, 320, A, 13)
        # self.l10= Ske_MixF(320, 320, A, 13)
